<?php 
    ...
    if (isset($_SESSION['success_message'])) {
        echo '<div id="success-message" class="alert alert-damaged">'.$_SESSION['success_message'].'</div>';
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            background: radial-gradient(circle, #e0f7fa, #000000ad);
            margin: 0;
            overflow: hidden;
        }
        .container {
        ...
        form {
            width: 500px;
            background-image: linear-gradient(128deg, #89898999, #00000085);
        }
        form h1{
            text-align: center;
        }
...
<body>
    ...
    <div class="container">
        <form method="post" id="qr-form" action="process_damaged_gallon.php">
            <h1 class="header">Damaged Gallon Scanner</h1>
            <hr>
            <center>
                <div id="reader"></div>
            </center>
        ...
        <a href="scan_qr.php" class="btn scan-btn">Scan Returned Gallon</a>
    </div>
